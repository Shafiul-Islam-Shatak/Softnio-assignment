...
const Error = () => {
    ...
    return (
        <div className="boxShadow px-10 w-full h-screen lg:flex-row gap-[30px] lg:gap-0 flex-col flex items-center justify-evenly py-20 rounded-xl">
            ...
            <div className="w-full lg:w-[30%] text-center lg:text-start">
                ...
                <h3 className="text-[#8093B8] text-[0.9rem] sm:text-[1.2rem]">Looks like your going to broken the link</h3>
