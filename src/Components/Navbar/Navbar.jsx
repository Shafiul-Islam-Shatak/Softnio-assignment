...
const Navbar = () => {
    ...
    return (
        ...
        >
            <div
                className={' top-0 z-40 w-full opacity-80 bg-transparent sticky'}
                style={{
                    background: " linear-gradient(123.4deg, #BD1F17 40.8%, #A61D13 76.4%, #8E1B0F 120.69%)",
                }}
            >
                <nav
                    className="flex items-center justify-between w-full relative bg-transparent boxShadow rounded-full px-[10px] py-[8px] max-w-[1372px] mx-auto ">
                    <div className="flex items-center ">
                        <div className="flex items-center gap-[6px]">
                            <img src="https://i.ibb.co.com/cbFqN0g/Group.png" alt="logo" className="w-[36px] " />
                            <h1 className="text-3xl text-white font-poppins">Resturent</h1>
                        </div>
                    ...
                    <div className="items-center gap-[10px] flex">
                        <button
                            className="py-[10px] text-[1rem] px-[24px] uppercase bg-yellow-500 text-black hover:bg-blue-400 transition-all duration-300 sm:flex hidden opacity-100 font-semibold">Book A Table
                        </button>
