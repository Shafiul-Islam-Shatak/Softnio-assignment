        ...
        >
            ...
            <div className="relative z-10 max-w-[1372px] mx-auto  items-center justify-center w-full h-full lg:py-[130px]">
                <div className="flex flex-col lg:flex-row items-center justify-between w-full">
                    {/* Text content */}
                    <div className="max-w-lg p-6 z-20">
                    ...
                    <div className="flex relative">
                        <img className="w-3/4 lg:w-[750px] mx-auto " src="https://i.ibb.co/Gp7qd4W/image-1.png" alt="Saudi cuisine" />
                        <div className="absolute -top-9 lg:-right-7  right-10">
                            <img src="https://i.ibb.co.com/qm0Yt1x/Vector.png" alt=""  />
                        </div>
                        <div className="flex items-center justify-center absolute bottom-2 right-14 lg:-right-14 lg:bottom-0">
